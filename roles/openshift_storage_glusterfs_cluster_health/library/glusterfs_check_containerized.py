...
#           This is an exact copy because there is no other good way to include this handy module in this repo
...
def fail(module, err):
    """Fail on error"""
    result = {"failed": True, "changed": False, "msg": err, "state": "unknown"}
